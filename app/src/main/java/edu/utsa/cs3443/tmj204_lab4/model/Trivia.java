package edu.utsa.cs3443.tmj204_lab4.model;
...
public class Trivia {
    ...
    // Setters & Getters for all the instance variables


    /*
    @param: Activity activity
    @return: Trivia object
    loadTrivia: takes in an Activity (MainActivity) from input as an argument, reads the file
    ...
    public Trivia loadTrivia(Activity activity){
        ...
        // How many lines are in this file? The number of lines are = to the number of trivia questions
        ...
        try{
            ...
            //when this loop ends, I'm standing right by the line I want to return
            ...
            // From index 4 forward, we have the desription
    ...
    private void identifyCorrectAnswer(){
        ...
        // if so, that option becomes the correct answer
    }
